...
function clickedCell(cell) {
	...
	window.setTimeout(function () {
		if (gameOver(board, COMP)) {
			...
			msg.innerHTML = "You lose!<br>But earned 9 bond points for playing.<br>And your pet got more hungry!";
			localStorage.bondpoints = parseInt(localStorage.bondpoints) + 7;
			localStorage.hunger = parseInt(localStorage.hunger) + 2;
		}
		if (emptyCells(board).length == 0 && !gameOverAll(board)) {
			var msg = document.getElementById("message");
			msg.innerHTML = "Draw!<br>But you earned 14 bond points.<br>And your pet got more hungry!";
